...
function boxx = boxDraw(center_x, center_y, x_size, y_size, color)
...
%areas 1-8
  boxDraw(500, 265, x_size, y_size, color);  boxDraw(160, 265, x_size, y_size, color);
  boxDraw(-160, 265, x_size, y_size, color); boxDraw(-500, 265, x_size, y_size, color);
  boxDraw(500, 65, x_size, y_size, color);   boxDraw(160, 65, x_size, y_size, color);
  boxDraw(-160, 65, x_size, y_size, color);  boxDraw(-500, 65, x_size, y_size, color);
  
  %areas 9&10
  boxDraw(-570, -190, y_size, x_size, color);   boxDraw(-370, -190, y_size, x_size, color);
