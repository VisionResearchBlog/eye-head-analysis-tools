%STP_STUDY_METRICS metric analysis
%    really quick file compare expert vs. fix finder

% $Id: stp_study_metrics.m,v 1.2 2001/08/17 20:28:15 pskirko Exp $
% pskirko 8.15.01
...
expert_file =       'diane.100pix.dat.expert';
fix_finder_file =   'diane.100pix.dat.fix';


% load em up

fix1 = stp_load_fix_expert(expert_file);
fix2 = load_dot_fix(fix_finder_file);
...
if 0 % don't want/need to visualize
